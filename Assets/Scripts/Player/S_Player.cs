...
public class S_Player : MonoBehaviour
{
    ...
    void Shoot()
    {
        if(Time.time - lastBulletTime >= 0.1f || lastBulletTime == -1.0f)
        {
            ...
            gameObject.GetComponent<ParticleGenerator>().GenerateParticles(SPRITE.FIRE, 5, gameObject.transform.position, new Vector3(0.0f, 0.2f, 0.0f), new Vector3(1.0f,1.0f,1.0f), 20.0f, 0.3f, -0.5f);
        }
    }
