...
public class E_ZEnemy:GenericEnemyScript
{
    ...
    {
        gameObject.GetComponent<ParticleGenerator>().GenerateParticles(SPRITE.WATER, 5, gameObject.transform.position, new Vector3(0.0f, 0.3f, 0.0f), new Vector3(0.05f, 0.05f, 0.05f), 90, 0.5f, -0.5f);
    }
}
